    ...
    return (
      <div className="mobile_introduction">
        ...
        <div className="mobile_content"><h3>四、研究方法、程序及參與者須配合的事項</h3>
          <p>
            1. 此實驗大約耗時一個小時，包含填答問卷以及訪談。<br/><br/>
            ...
            7. 實驗結束後，為感謝您參與本研究的時間與付出，我們會提供新台幣200元酬勞，我們會將領據email給您（依學校規定，領據中需要填寫姓名、手機、身分證字號、 公司、職稱與戶籍地址等個資，以利申報所得稅，處理完報帳事宜後我們會將這些個資刪除），請您填寫之後email寄回，我們確認收到之後會將酬勞透過行動支付或銀行匯款給您。<br/><br/>
        ...
        <div className="mobile_content"><h3>七、參與者權益</h3>
          <p>
            (一)酬勞<br/>完成實驗後將會提供您200元新台幣酬勞。若您中途退出實驗，我們將無法提供您酬勞。<br/><br/>(二)損害賠償<br/>
