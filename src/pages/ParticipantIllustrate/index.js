      ...
      <div className="mobile_introduction">
        ...
        <div className="mobile_content"><h3>一、研究背景</h3>
          <p>
            ...
            工人的執行意願及速度也都會降低。然而尚未有研究結合以上兩點後，探討使用者想降低等待時間時，「不同資源需求程度」是如何影響其所願意提供的獎金金額。
        ...
        <div className="mobile_content"><h3>二、研究目的</h3>
          <p>
            探討使用者為了減少等待時間，在不同的資源需求程度下，與願意提供的獎金金額的關係。
          </p>
        </div>
        <p></p>
        ...
        <div className="mobile_content"><h3>七、參與者權益</h3>
          <p>
            ...
            若您因參與本計畫而發生不良反應或損害，您仍受法律保障，若您因參與本計畫而發生不良反應或損害，您仍受法律保障，本計畫主持人張永儒依法負責，並提供本研究相關訊息記諮詢，
            但本同意書上所記載之可預期不良反應，原則上不予補償。<br/><br/>(三)個人資料保護機制<br/>本研究計畫主持人會確保個別資料的機密與參與者的隱私。
            本研究收集電子信箱用途僅作為報酬聯絡事宜，待處理完之後就會將聯絡資料刪除。<br/><br/>(四)如果您在研究過程中，對於參與者權利有意見、懷疑或因參與研究而受害時，
            可與國立陽明交通大學人體與行為研究倫理委員會聯絡請求諮詢，其電話號碼為：03-5712121轉53270；email：rec@nctu.edu.tw；住址：300新竹市大學路1001號人體與行為研究倫理委員會。
          </p>
        </div>
        <p></p>
