...
let questions = [{
  ...
  'Category':'撞球館',
  'Question':'設想現在是週六下午，你突然想去附近的撞球館打撞球。\r\n\r\n但今天整天都沒事，撞球館也是24小時的，因此也不一定要急著現在去打球。\r\n\r\n由於週末下午是熱門時段，你預期現在人會很多，因此想先確定一下該撞球館的即時資訊。\r\n\r\n即時資訊有提供「撞球館內即時人潮」（如圖一）以及「球桌即時使用狀況」（如圖二）。',
  'ImageURL':'https://imgur.com/uZmX2v0.jpg'
},{
  'Test':'本身沒有預期且兩種即時資訊相互矛盾',
  'Category':'撞球館',
  'Question':'設想你最近剛搬到新的城市，今天打算去附近的撞球館打撞球。\r\n\r\n最晚半小時後要到達球館，不然打球的時間會不夠。\r\n\r\n由於完全沒有預期撞球館的人多不多，因此想先確定一下該撞球館提供的的即時資訊。\r\n\r\n即時資訊有提供「撞球館內即時人潮」（如圖一）以及「球桌即時使用狀況」（如圖二）。',
